...
- [x] **Static middleware for frontend** - Displays public directory using express.
...
- [x] **Stores data in MongoDB** - All data is stored persistently in MongoDB.
- [x] **Stores credentials in MongoDB** - AuthTokens and passwords are stored securely in MongoDB.
